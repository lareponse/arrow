...
require 'add/dad/html.php';
require 'add/dad/guard_auth.php';
...
$quest = io($in_path, $out_path, function($quest) use ($out_path){
    slot('main',$quest[IO_SEND | IO_LOAD]);
