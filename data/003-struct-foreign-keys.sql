...
ALTER TABLE training
    ...
    ADD CONSTRAINT fk_training_level
        FOREIGN KEY (level_id) REFERENCES taxonomy(id) ON DELETE RESTRICT;
...
ALTER TABLE event_booking
    ...
    ADD CONSTRAINT fk_event_booking_status
        FOREIGN KEY (status_id) REFERENCES taxonomy(id) ON DELETE RESTRICT;
...
ALTER TABLE contact_request
    ...
    ADD CONSTRAINT fk_contact_request_subject
        FOREIGN KEY (subject_id) REFERENCES taxonomy(id) ON DELETE RESTRICT;
