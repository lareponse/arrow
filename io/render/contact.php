...
<section class="newsletter wide">
    <div class="container">
        ...
        <div class="flex gap-lg justify-center flex-wrap">
            <a href="tel:<?= viewport('coproacademy', 'telephone') ?>" class="btn btn--primary btn--lg">Appeler maintenant</a>
            <a href="mailto:<?= viewport('coproacademy', 'email') ?>" class="btn btn--secondary btn--lg">Envoyer un email</a>
        </div>
    </div>
</section>
